    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-link">
                    <a class="nav-link" href="doacoes.php">Doação</a>
                </li>
                <?php
session_start();
...
?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2>Sobre a Importância das Árvores</h2>
                <p>As árvores desempenham papel vital na sustentabilidade ambiental, proporcionando oxigênio,
                     absorvendo carbono e abrigando diversidade.
                      A doação para o plantio de árvores contribui para a preservação do meio ambiente,
                       promovendo equilíbrio climático e bem-estar global. Invista no futuro,
                        plante esperança. 🌳💚</p>
            </div>
        </div>
    </div>
